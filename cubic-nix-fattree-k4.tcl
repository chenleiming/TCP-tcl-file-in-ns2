...
set ecn 0 ;#ecn=1,enable ECN
set KK 65  ;#KK is ECN threshhold

set stoptime 10 ;#simulator time

set cwndInterval 0.001
 
set ns [new Simulator]
set flow_tcp cubic ;#TCP=cubic
...
$ns color 3 Green
$ns color 4 Blue
$ns color 5 Purple ;#紫色
$ns color 6 DarkOliveGreen ;#暗橄榄绿色
$ns color 7 Orange ;#橙色
$ns color 8 Tan  ;#黄褐色
$ns color 9 Cyan ;#青色
$ns color 10 Orange
